 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "        print('obscuredPhrase: {}'.format(self.obscuredPhrase))\n",
    "        print('guessed: {}\\n'.format(self.guessed))\n",
    "        \n",
    ...
    "        return randNum > self.difficulty\n",
    "    \n",
    ...
    "            if l not in guessed:\n",
    "                if l not in VOWELS:\n",
    "                    canBeguessedLetters.append(l)\n",
    "                elif l in VOWELS:\n",
    "                    if self.prizeMoney > VOWEL_COST:\n",
    "                        canBeguessedLetters.append(l)\n",
    "                    \n",
    "        return canBeguessedLetters\n",
    "     \n",
    "    def getMove(self, category, obscuredPhrase, guessed):\n",
    "        var = self.smartCoinFlip()\n",
